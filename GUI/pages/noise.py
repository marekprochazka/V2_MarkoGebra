...
class Noise(Frame):
    def __init__(self, parent, controller):
        ...
        self.generate_button.grid(row=3, column=0, sticky="nswe")
        self.lock = t.Button(self, text="Uzamknout",
                             command=self.__update_noise_data)
        self.lock.grid(row=3, column=1, sticky="nswe")

        self.quantity_label = t.Label(self, text="Množství", font=fonts()["SMALL_FONT"])
        self.quantity_label.grid(row=0, column=0, sticky="nswe", pady=10)
        self.dispersion_label = t.Label(self, text="Rozptyl", font=fonts()["SMALL_FONT"])
        self.dispersion_label.grid(row=0, column=1, sticky="nswe", pady=10)
        ...
        self.quantity.grid(row=1, column=0, sticky="we")
        ...
        self.dispersion.grid(row=1, column=1, sticky="we")
        ...
        self.color.grid(row=2, column=0, columnspan=2, sticky="we", pady=10)
