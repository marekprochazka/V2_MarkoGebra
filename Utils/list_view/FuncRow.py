...
class FunctionRow(BaseRow):
    def __init__(self, parent, func_value):
        ...
        self.entry_fun = t.Entry(self.parent, justify="center", width=17)
        ...
        self.col_but.grid(row=0,column=3,padx=4)
        self.entry_size.grid(row=0,column=4,padx=4)
        self.del_but.grid(row=0, column=5, padx=4)
        self.save_but.grid(row=0, column=6, padx=4)